...
git clone [https://github.com/Uncanny01/UchihaAi_Hackathon.git](https://github.com/Uncanny01/UchihaAi_Hackathon.git)
cd UchihaAi_Hackathon
...
Error Resilience: We implemented st.session_state and st.warning to ensure that even if a model fails, the user is notified of the "fallback" transition rather than seeing a crash.
